...
summary_dict['total_mapped_count'] = int(flagstat_lines[6].split(" ")[0])
summary_dict['properly_paired_count'] = int(flagstat_lines[11].split(" ")[0])
...
keys = ['total_read_count','total_mapped_count', 'properly_paired_count', 'singleton_count', 'avg_depth', 'std_depth', 'total_breadth']
