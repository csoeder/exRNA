...
The raw alignments were filtered for mapping/sequencing quality (`-q 20 -F 0x0100 -F 0x0200 -F 0x0300 -F 0x04`), and deduplication (`-rS`). Multimappers are removed at the counting step.
...
Many reads ultimately did not align in proper pairs; these were extracted and their metagenomics investigated using Kraken2 [@Wood2014]. The "Standard" index (10/9/2023) was downloaded from Ben Langmead's repository (<https://benlangmead.github.io/aws-indexes/k2>)
